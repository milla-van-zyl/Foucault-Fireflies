...
# Some
goL = 9.81        # g/L where L is the length of the pendulum
...
if __name__ == "__main__":
  ...
  plt.savefig("x_of_t.pdf") # save the graph as a pdf file
  plt.show()
  ...
  plt.plot(t_list_min, v_list_min, label="min")
  plt.plot(t_list_max, v_list_max, label = "max")
  plt.legend()
  plt.xlabel("t", fontsize=20)
